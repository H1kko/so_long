...
/*   Updated: 2025/01/16 17:02:33 by maregnie         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	convert_textures(t_game *game)
{
	...
	if (!textures)
		return (0);
	sprites->wall = mlx_texture_to_image(game->mlx, textures->wall);
	sprites->ground = mlx_texture_to_image(game->mlx, textures->ground);
	sprites->player = mlx_texture_to_image(game->mlx, textures->player);
	sprites->exit = mlx_texture_to_image(game->mlx, textures->exit);
	sprites->coin = mlx_texture_to_image(game->mlx, textures->coin);
	game->sprite = sprites;
...
int	place_textures(t_game *game)
{
	...
	if (mlx_image_to_window(game->mlx, 
		game->sprite->player, game->player_x * 32, game->player_y * 32) == -1)
		return (0);
	return (1);
}